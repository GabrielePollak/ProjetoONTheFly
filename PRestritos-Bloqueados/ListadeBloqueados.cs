...
{
    internal class ListadeBloqueados
    {
        public ArquivodeBloqueados HEAD { get; set; }
        public ArquivodeBloqueados TAIL { get; set; }
        ...
        public void Push(ArquivodeBloqueados aux)
        {
        ...
        public void Find(string CNPJ)
        {
            ...
            {
                ArquivodeBloqueados auxiliar = HEAD;
                bool achou = false;
                do
                {
