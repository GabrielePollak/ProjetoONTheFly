...
{
    internal class ListaRestritos
    {
        public ArquivodeRestritos HEAD { get; set; }
        public ArquivodeRestritos TAIL { get; set; }
        ...
        public void Push(ArquivodeRestritos aux)
        {
        ...
        public void Find(string CPF)
        {
            ...
            {
                ArquivodeRestritos auxiliar = HEAD;
                bool achou = false;
                do
                {
                    if (auxiliar.CPF == CPF)
